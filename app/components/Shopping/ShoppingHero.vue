<template>
  <header class="relative h-[400px] w-full flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
      <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-4 tracking-tight drop-shadow-lg">Bring a Piece of Sri Lanka Home
      </h1>
      <p class="text-slate-300 text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed drop-shadow-md">The ultimate guide to
        authentic souvenirs, bustling markets, and smart shopping in the Pearl of the Indian Ocean.</p>
      <button
        class="mt-8 bg-primary hover:bg-teal-800 text-white font-medium py-3 px-8 rounded-full shadow-md transition transform hover:scale-[1.02] active:scale-[0.98]">
        Start Exploring
      </button>
    </div>
  </header>
