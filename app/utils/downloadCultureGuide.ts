...
<head>
  ...
  <title>Sri Lanka Cultural Etiquette Guide - CeylonWiki</title>
  <style>
    @page {
      size: A4;
      margin: 20mm;
...
<body>
  ...
  <!-- Footer -->
  <div class="footer">
    <p>Generated by CeylonWiki • ${new Date().toLocaleDateString()}</p>
    <p>Visit ceylonwiki.com for the complete interactive guide</p>
  </div>
</body>
</html>
  `.trim()
