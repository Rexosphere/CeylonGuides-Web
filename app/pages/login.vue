    ...
    <div class="flex flex-1 flex-col justify-center px-6 py-12 lg:flex-none lg:px-20 xl:px-24 bg-white dark:bg-background-dark lg:w-[480px] xl:w-[600px] border-l border-[#f4f1f0] dark:border-gray-800 relative z-10">
      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <form class="space-y-5" @submit.prevent="handleLogin">
          ...
          <!-- Main Action -->
          <div class="pt-2">
            <button class="flex w-full justify-center items-center rounded-lg bg-primary px-4 h-12 text-base font-bold text-white shadow-sm hover:bg-[#d64d1e] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary transition-all active:scale-[0.98]" type="submit">
              Log In
            </button>
          </div>
        </form>
        ...
        <p class="mt-8 text-center text-sm text-[#896c61] dark:text-gray-400">
          New to CeylonGuide?
          <NuxtLink to="/signup" class="font-bold text-primary hover:text-[#d64d1e] transition-colors ml-1">Create an account</NuxtLink>
        </p>
      </div>
    </div>
  </div>
...
useHead({
  ...
  meta: [
    { 
      name: 'description', 
      content: 'Log in to your CeylonGuide account to continue your virtual journey through Sri Lanka.'
    }
  ]
})
</script>
